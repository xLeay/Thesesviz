...
<!-- TODO: bouton de nav pour revenir à l'acceuil -->
<!-- TODO: bouton retour sur une thèse pour retourner à la recherche précédente (window.history.back()) -->
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", async () => {
        ...
        let data = <?= json_encode($data->loadData()[4]); ?>;
